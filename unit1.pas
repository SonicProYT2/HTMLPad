...
begin
  ...
  If FileExists('language.conf') then
      ...
      //установка русского окончена
         ...
         // АААаайААААйййй крокодилы бегемоты
         // ААааааййййААААййй обезьяны кашалоты
         // АййййААййй и зелёный попугай
...
begin
  ...
  if OpenDialog1.Execute then
     begin
       ...
       Form1.Caption:=editingTranslation+editableFile+' | JustPad 1.3';
     end;
end;

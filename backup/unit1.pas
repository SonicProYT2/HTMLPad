...
begin
  ...
  if (language = 'EN') then
    Form1.Caption := 'New File | JustPad 1.3';
  if (language = 'UA') then
    Form1.Caption := 'Новий файл | JustPad 1.3';
  if (language = 'RU') then
...
begin
  Memo1.Text := '<html>' + #13 + #9 + '<head>' + #13 + #9 + #9 +
    '<title>TITLE<title>' + #13 + #9 + #9 + '<meta charset="utf-8">' +
    #13 + #9 + '<style>' + #13 + #9 + #9 + #9 + '' + #13 + #9 +
    '</style>' + #13 + #9 + '<script>' + #13 + #9 + #9 + '' + #13 + #9 +
    '</script>' + #13 + #9 + '</head>' + #13 + #9 + '<body>' + #13 +
    #9 + #9 + '' + #13 + #9 + '</body>' + #13 + '</html>';
end;

procedure TForm1.MenuItem15Click(Sender: TObject);
begin
  Memo1.Text := '@echo off' + #13 + 'title >> WINDOWS TITLE <<' +
    #13 + 'color >> COLOR (for help use "color help" in cmd) <<';
end;

procedure TForm1.MenuItem16Click(Sender: TObject);
begin
  Memo1.Text := 'program Project;' + #13 + #9 + 'begin' + #13 + #9 +
    #9 + '' + #13 + #9 + 'end.';
end;

procedure TForm1.MenuItem18Click(Sender: TObject);
begin
  Memo1.Text := '[autorun]' + #13 + 'open=Application.exe' + #13 +
    'label=Drive' + #13 + 'shellexecute=Readme.txt' + #13 +
    'action=Open My program' + #13 + 'icon=Application.exe';
end;
...
begin
  ...
  begin
    ...
    if (languageCheck = 'EN') then
      language := 'EN';
    if (languageCheck = 'UA') then
      language := 'UA';


    if (languageCheck <> 'RU') and (languageCheck <> 'EN') and
      (languageCheck <> 'UA') then
    begin
      language := 'EN';
    end;
    ...
    begin
      ...
      //Form2.Button3.Caption:='Колір фону';
      Form2.Label1.Caption := 'Для зміни мови' + #13 +
        'перезавантажте JustPad.';
      ...
      Form4.Label2.Caption :=
        'JustPad - це дуже простий текстовий редактор написаний на Free Pascal.'
        + #13 + #13 + 'Зробив KATAR і egfilin' + #13 +
        'Репозиторій на GitHub: https://github.com/KATAR-github/' +
        #13 + 'Наші Discord''і:SHCHEGLAKOF#4920 і egfilin#0657' +
        #13 + #13 + 'Дата складання: 23.11.2020';
    end;
    ...
    //    + #13 + #13 + 'Разаработали KATAR и egfilin' +
    //    #13 + 'Репозиторий на GitHub: https://github.com/KATAR-github/JustPad'#10#13'Наши Discord''ы: SHCHEGLAKOF#4920 и egfilin#0657' + #13 +
    //    #13 + 'Дата сборки: 23.11.2020';
    //end;
...
begin
  if (language = 'RU') then
    StatusBar1.Panels.Items[0].Text :=
      'Символов: ' + IntToStr(Length(Memo1.Text));
  if (language = 'UA') then
    StatusBar1.Panels.Items[0].Text :=
      'Символів:' + IntToStr(Length(Memo1.Text));
  if (language = 'EN') then
    StatusBar1.Panels.Items[0].Text := 'Characters: ' + IntToStr(Length(Memo1.Text));
end;
